      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto space-y-5 md:space-y-6 text-sm md:text-lg leading-relaxed">
          ...
          <ScrollReveal delay={200}>
            <div className="p-5 bg-card border border-primary/20 rounded-xl my-6">
          ...
          <ScrollReveal delay={350}>
            <h3 className="font-heading text-xl md:text-2xl font-bold text-center text-foreground pt-4">
              A GRANDE Descoberta: O <span className="text-gradient-gold">"Efeito Inversão Psicológica"</span>
            </h3>
          </ScrollReveal>
          ...
          <ScrollReveal delay={500}>
            <p className="text-center text-foreground font-semibold text-base md:text-lg">
              Hoje, + de 18 meses depois, já ajudei <span className="text-primary">+ 3.847 mulheres</span> a fazerem a mesma transformação. E ressignificação de suas vidas amorosas.
            </p>
            <p className="text-xl text-center font-bold text-primary mt-2">
              E agora é SUA vez. ✨
            </p>
          </ScrollReveal>
        </div>
