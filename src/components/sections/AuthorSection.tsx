      ...
      <div className="container mx-auto px-4">
        ...
        <ScrollReveal delay={100}>
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-card p-6 md:p-12 rounded-3xl border border-primary/20 shadow-metallic">
              <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
                <div className="flex-shrink-0">
                  <div className="relative">
                    <div className="w-40 h-40 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-primary/40 shadow-metallic">
                      <img
                        src={marinaImage}
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-gradient-metallic px-4 py-2 rounded-full shadow-metallic">
                      <p className="text-white font-semibold text-xs md:text-sm whitespace-nowrap">
                        Marina • Facilitadora
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex-1 space-y-4 text-center md:text-left">
                  <p className="text-muted-foreground leading-relaxed text-sm md:text-base">
                    Olá, minhas queridas! Aqui é a <strong className="text-foreground">Marina</strong>, facilitadora e criadora do <span className="text-primary">Método Nefertiti</span>. Um conteúdo que ajudou e continua ajudando TANTAS mulheres, que ouso dizer, que é meu bebê, pois tenho tamanho carinho pelo propósito que está envolvido.
                  ...
                  <div className="p-4 bg-primary/10 border border-primary/30 rounded-xl mt-6">
                    <p className="text-foreground font-medium italic text-sm md:text-base font-quote">
        ...
        <ScrollReveal delay={200}>
          <div className="max-w-3xl mx-auto mt-10 space-y-4">
            ...
            <div className="p-4 md:p-5 bg-card/60 border border-primary/15 rounded-xl">
              <p className="text-muted-foreground text-xs md:text-sm">
                <strong className="text-foreground">P.P.S.:</strong> Lembra da pergunta que Dra. Sophia me fez? "Você acha que Nefertiti chorava no banheiro?" <strong className="text-primary">NÃO.</strong> E nem você vai precisar chorar mais. Sua transformação começa AGORA. E SÓ DEPENDE DE UM CLIQUE.
              </p>
            </div>
          </div>
        </ScrollReveal>
