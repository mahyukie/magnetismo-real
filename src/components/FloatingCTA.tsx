...
export const FloatingCTA = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-3 md:p-4 bg-card/95 backdrop-blur-md border-t border-secondary/30 shadow-silver animate-in slide-in-from-bottom duration-500">
